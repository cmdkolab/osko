window.I18n = {
    ...
    dicts: {
        en: {
            ...
            'system.locked_msg': 'System is locked. Unlock to launch applications.',
            ...
            'about.kernel_info': 'V8 / OS(KO) Core',
            'syslog.saved_to': 'Logs saved to {0}',
            'permissions.denied_msg': 'App "{0}" tried to use "{1}" without permission.',
            'terminal.theme_usage': 'Usage: theme <default|matrix|cyberpunk|classic>',
            'syslog.app_title': 'SysLog',
            'notes.bold': 'Bold',
            'notes.italic': 'Italic',
            'notes.wrap_on': 'ON',
            'notes.wrap_off': 'OFF',
            ...
            'explorer.view': 'View',
            'terminal.cmd_cp': 'Copy file or directory',
            'terminal.cmd_mv': 'Move/rename file or directory',
            'terminal.cmd_touch': 'Create empty file or update timestamp',
            'terminal.cmd_head': 'Show first N lines of file',
            'terminal.cmd_tail': 'Show last N lines of file',
            'terminal.cmd_find': 'Search for files by name',
            'terminal.cmd_tree': 'Display directory tree',
            'terminal.file_not_found': '{0}: not found',
            'terminal.cp_usage': 'cp [-r] <source> <dest>',
            'terminal.mv_usage': 'mv <source> <dest>',
            'terminal.touch_usage': 'touch <file>',
            'terminal.head_usage': 'head [-n N] <file>',
            'terminal.tail_usage': 'tail [-n N] <file>',
            'terminal.find_usage': 'find <path> [name]',
            'terminal.tree_usage': 'tree [path]',
            'terminal.no_files': 'No files found'
        },
        pl: {
            ...
            'system.locked_msg': 'System jest zablokowany. Odblokuj, aby uruchamiać aplikacje.',
            'system.status': 'Status',
            ...
            'about.kernel_info': 'V8 / Rdzeń OS(KO)',
            'syslog.saved_to': 'Logi zapisano do {0}',
            'permissions.denied_msg': 'Aplikacja "{0}" próbowała użyć "{1}" bez uprawnień.',
            'terminal.theme_usage': 'Użycie: theme <default|matrix|cyberpunk|classic>',
            'syslog.app_title': 'SysLog',
            'notes.bold': 'Pogrubienie',
            'notes.italic': 'Kursywa',
            'notes.wrap_on': 'WŁ.',
            'notes.wrap_off': 'WYŁ.',
            'notes.search': 'Szukaj...',
            'notes.replace': 'Zamień...',
            'explorer.view': 'Widok',
            'terminal.help_system': 'system - Wyświetl zaawansowane informacje o systemie i użyciu pamięci',
            'terminal.cmd_cp': 'Kopiuj plik lub katalog',
            'terminal.cmd_mv': 'Przenieś/zmień nazwę pliku lub katalogu',
            'terminal.cmd_touch': 'Utwórz pusty plik lub zaktualizuj czas',
            'terminal.cmd_head': 'Pokaż pierwsze N linii pliku',
            'terminal.cmd_tail': 'Pokaż ostatnie N linii pliku',
            'terminal.cmd_find': 'Szukaj plików po nazwie',
            'terminal.cmd_tree': 'Wyświetl drzewo katalogów',
            'terminal.file_not_found': '{0}: nie znaleziono',
            'terminal.cp_usage': 'cp [-r] <źródło> <cel>',
            'terminal.mv_usage': 'mv <źródło> <cel>',
            'terminal.touch_usage': 'touch <plik>',
            'terminal.head_usage': 'head [-n N] <plik>',
            'terminal.tail_usage': 'tail [-n N] <plik>',
            'terminal.find_usage': 'find <ścieżka> [nazwa]',
            'terminal.tree_usage': 'tree [ścieżka]',
            'terminal.no_files': 'Nie znaleziono plików'
        }
    },
    t(key, ...args) {
