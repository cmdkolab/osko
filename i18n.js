window.I18n = {
    ...
    dicts: {
        en: {
            ...
            'terminal.help': 'Available commands: ls, cd, cat, edit, mkdir, rm, clear, echo, date, pwd, help, version, play, uptime, ps, system',
        ...
        pl: {
            ...
            'terminal.help': 'Dostępne komendy: ls, cd, cat, edit, mkdir, rm, clear, echo, date, pwd, help, version, play, uptime, ps, system',
            'terminal.help_system': 'system - Wyświetla zaawansowane informacje o systemie i zajętości VFS',
            'system.status': 'Status'
        }
    },
    t(key, ...args) {
