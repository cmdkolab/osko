window.I18n = {
    ...
    dicts: {
        en: {
            ...
            'terminal.help': 'Available commands: ls, cd, cat, edit, mkdir, rm, clear, echo, date, pwd, help, version, play, uptime, ps, du, system',
            'terminal.help_system': 'system - Display advanced system info and storage occupancy',
            'terminal.help_du': 'du <path> - Calculate disk usage recursively',
            'terminal.du_total': 'Total size for {0}: {1}',
        ...
        pl: {
            ...
            'terminal.help': 'Dostępne komendy: ls, cd, cat, edit, mkdir, rm, clear, echo, date, pwd, help, version, play, uptime, ps, du, system',
            'terminal.help_system': 'system - Wyświetla zaawansowane informacje o systemie i zajętości VFS',
            'terminal.help_du': 'du <ścieżka> - Oblicza rekurencyjnie rozmiar folderów',
            'terminal.du_total': 'Całkowity rozmiar {0}: {1}',
            'system.status': 'Status'
        }
    },
    t(key, ...args) {
